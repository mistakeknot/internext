# internext Philosophy

## Purpose
Work prioritization and next-task analysis for Claude Code — tradeoff-aware recommendations from project state.

## North Star
Advance internext through small, testable changes aligned to its core mission: Work prioritization and next-task analysis for Claude Code — tradeoff-aware recommendations from project state.
